...
const GATE_KB = {
  ...
  skew_flow:        { q: 'Is institutional options flow aligned with your trade?', pass: 'Put/call skew is normal — no unusual institutional hedging pressure against your direction.', fail: 'Skew is elevated — institutions are aggressively buying protection. Consider sizing down.', why: 'When institutions buy puts heavily, put IV rises above call IV. Selling puts into that flow means you\'re on the wrong side of smart money hedging. The premium is rich, but the market is telling you something.' },
};
