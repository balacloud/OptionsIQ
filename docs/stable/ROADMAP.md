...
| v0.31.0 | Day 47 | **README full rewrite + Phase 7c trading effectiveness improvements.** README rewritten fixing 9+ stale sections. ETF_OPTIONS_LIQUID_TIER1 constant (QQQ/IWM/XLF/XLK/XLY). _is_early_market_session() helper. Actionable liquidity gate messages: Tier2 ETFs get "try QQQ/XLF", early session gets "rescan after 10 AM". Phase7c_Actionable_Day47.md research doc. |
