# Known Issues — Day 61 (May 31, 2026)
...
## New This Session (Day 61)

None. Day 61 was analysis-only (ibkr-scan live test). No code changes.

## Resolved This Session (Day 61)

None.

## Carried Forward (resolved in earlier sessions)

### Day 60 Features (no resolutions — new feature session)
- scan_context_parser.py shipped (parse_scan_context + apply_scan_context_to_gate_payload)
- _trend_ema_gate() added to all 4 ETF tracks in gate_engine.py
